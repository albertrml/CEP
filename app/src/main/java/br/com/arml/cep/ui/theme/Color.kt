...
val primaryContainerDark = Color(0xFF172979)
...
val surfaceContainerLowDark = Color(0xFF000C40)    // Card Background
val surfaceContainerDark = Color(0xFF040015)      // Bottom Bar
val backgroundDark = Color(0xFF03030C)
